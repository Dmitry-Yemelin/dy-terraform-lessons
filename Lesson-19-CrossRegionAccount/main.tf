...
provider "aws" { // This is example to use Another AWS Account
  ...
  region = "ca-central-1"
  #access_key = "xxxxxxxxxxxx" - do not do like that, assume role is preferred
  #secret_key = "yyyyyyyyyyyyyyyyyyyyyyyyyyyyyy" - do not do like that, assume role is preferred
