...
#
# export TF_VAR_region=us-west-2       - how to setup environment variables for terraform plan/apply
# export TF_VAR_instance_type=t2.small - how to setup environment variables for terraform plan/apply
#----------------------------------------------------------
